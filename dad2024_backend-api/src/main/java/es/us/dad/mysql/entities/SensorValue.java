...
public class SensorValue {
	...
	public SensorValue(Float value, Integer idGroup, Integer idSensor, Long timestamp, Boolean removed) {
		super();
		this.value = value;
	...
	public SensorValue(Integer idSensorValue, Float value,  Integer idGroup, Integer idSensor, Long timestamp, Boolean removed) {
		super();
