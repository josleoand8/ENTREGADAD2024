...
public class ActuatorStatus {
	...
	public ActuatorStatus(Float status, Boolean statusBinary, Integer idActuator, Integer idGroup, Long timestamp, Boolean removed) {
		super();
		this.status = status;
	...
	public ActuatorStatus(Integer idActuatorState, Float status, Boolean statusBinary, Integer idActuator, Integer idGroup,
